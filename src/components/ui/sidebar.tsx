...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "h-14 px-4 py-4 flex flex-row md:hidden items-center justify-between bg-neutral-100 dark:bg-[#111111] border-b dark:border-[#2C2C2E] w-full"
        )}
        {...props}
      >
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className={cn(
                "fixed inset-0 h-[100dvh] w-full bg-white dark:bg-[#050505] p-10 pb-[max(2.5rem,env(safe-area-inset-bottom,2.5rem))] z-[100] flex flex-col justify-between",
                className
              )}
            >
              <div
...
export const SidebarLink = ({
  ...
  return (
    <Link
      href={link.href}
      className={cn(
        "flex items-center justify-start gap-2 group/sidebar py-2 text-neutral-700 dark:text-[#F2F2F7]",
        className
      )}
      onClick={() => {
