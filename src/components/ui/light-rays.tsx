...
export function LightRays({
  ...
  // Detecção dinâmica de cor: azul suave no modo claro, vermelho Prisma no modo escuro
  const activeColor = color || (mounted && resolvedTheme === "light" 
    ? "rgba(14, 165, 233, 0.18)" // Azul claro suave elegante
    : "rgba(229, 9, 20, 0.16)")  // Vermelho Prisma clássico
