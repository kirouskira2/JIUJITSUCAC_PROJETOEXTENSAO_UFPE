...
export default function AdminPrintQrPage() {
  ...
  return (
    <div className="flex flex-col h-full items-center justify-center py-10 px-4 min-h-[80vh] print:py-0 print:px-0 print:min-h-0 print:h-screen print:bg-white">
      ...
      <div className="w-full max-w-2xl bg-surface-container print:bg-white print:border-none border border-border rounded-3xl p-8 flex flex-col items-center relative overflow-hidden shadow-2xl print:shadow-none">
