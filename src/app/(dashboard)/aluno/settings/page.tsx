...
export default async function AlunoSettingsPage() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto flex flex-col gap-6 py-6 px-4 md:px-0">
      ...
      {/* Profile Card */}
      <div className="relative rounded-3xl border border-border overflow-hidden p-6 flex flex-col gap-5 bg-surface-container">
        <div
        ...
        <div className="flex items-center gap-4 relative z-10">
          <div className="w-16 h-16 rounded-full flex items-center justify-center shrink-0 border-2 border-border bg-neutral-100 dark:bg-[#1C1C1E]">
      ...
      {/* Info */}
      <div className="rounded-3xl border border-border p-5 bg-surface-container">
